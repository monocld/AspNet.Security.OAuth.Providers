...
public static class MonoCloudAuthenticationOptionsTests
{
    [Fact]
    public static void Validate_Throws_If_AuthorizationEndpoint_Not_Set()
    {
        ...
        var options = new MonoCloudAuthenticationOptions()
        {
            ...
            TokenEndpoint = "https://monocloud.local",
            UserInformationEndpoint = "https://monocloud.local",
        };
    ...
    public static void Validate_Throws_If_TokenEndpoint_Not_Set()
    {
        ...
        var options = new MonoCloudAuthenticationOptions()
        {
            AuthorizationEndpoint = "https://monocloud.local",
            ClientId = "ClientId",
            ClientSecret = "ClientSecret",
            UserInformationEndpoint = "https://monocloud.local",
        };
