...
using static AspNet.Security.OAuth.MonoCloud.MonoCloudAuthenticationConstants;

namespace AspNet.Security.OAuth.MonoCloud;

/// <summary>
/// Defines a set of options used by <see cref="MonoCloudAuthenticationHandler"/>.
/// </summary>
public class MonoCloudAuthenticationOptions : OAuthOptions
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MonoCloudAuthenticationOptions"/> class.
    /// </summary>
    public MonoCloudAuthenticationOptions()
    {
        ClaimsIssuer = MonoCloudAuthenticationDefaults.Issuer;
        CallbackPath = MonoCloudAuthenticationDefaults.CallbackPath;
        UsePkce = true;
    ...
    /// <summary>
    /// Gets or sets the MonoCloud tenant domain.
    /// </summary>
    public string? DomainName { get; set; }

    /// <summary>
    /// Gets or sets the MonoCloud tenant region.
    /// </summary>
